            ...
            <div className="py-4 bg-stone-100">
                <div className="max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-between">
                    <div className="text-center">
                        <p className=" Logo mt-4 text-sm leading-7 text-gray-500 font-regular">
                            F.A.Q
                        </p>
                        ...
                        <ul className="">
                            <li className="text-left mb-10">
                                <div className="flex flex-row items-start mb-5">
                                    ...
                                    <div className="bg-gray-200 p-5 px-10 w-full flex items-center">
                                ...
                                <div className="flex flex-row items-start">
                                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                                        <p className="text-gray-700 text-sm">
                                            ...
                                            blanditiis ratione. Lorem ipsum,
