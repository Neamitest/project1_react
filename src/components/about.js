            ...
            <section className="flex items-center bg-stone-100 lg:h-screen font-poppins dark:bg-gray-800 ">
                <div className="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
                    <div className="px-4 mb-10 md:text-center md:mb-20">
                        <p
                            style={color}
                            className="mb-2 text-lg font-semibold   dark:text-gray-400"
                        >
                            About Us
                        </p>
                    ...
                    <div className="flex flex-wrap items-center">
                        <div className="w-full px-4 mb-10 md:w-1/2 lg:mb-0 ">
                            ...
                            <ul className="mb-10">
                                <li className="flex items-center mb-4 text-base text-gray-600 dark:text-gray-400">
                                    <span style={color} className="mr-3   ">
                                        <svg
                            ...
                            <Link
                                style={bg}
                                className="px-4 py-2 text-gray-100  rounded-md hover:text-gray-100  "
                            >
                                Learn more
                            </Link>
                        </div>
                        <div className="relative w-full px-4 mb-10 md:w-1/2 lg:mb-0">
                            <img
                                src="https://cdn.theforkmanager.com/static/styles/blog_article_header_image/public/wp-blog/5-el-tenedor-gestion-restaurantes-contratar-al-mejor-chef.jpg?itok=hDZiX5AS"
                                alt=""
